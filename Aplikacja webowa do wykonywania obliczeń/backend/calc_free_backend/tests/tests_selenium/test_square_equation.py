...
class SquareEquationSeleniumTestsCases(unittest.TestCase):
    ...
    def test_page(self):
        ...
        page = self.driver.find_element(By.ID, "squareEquation")
        page.click()
        ...
        popover = self.driver.find_elements(By.ID, "popoverBody")
        self.assertEqual(len(popover), 0, msg = "Popover should not be open")
        equation_text_field.send_keys("7,0x^2-14,0x+2,0")
        time.sleep(self.time_sleep)
