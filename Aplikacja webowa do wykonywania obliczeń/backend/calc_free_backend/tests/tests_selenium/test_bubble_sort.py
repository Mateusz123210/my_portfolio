...
class BubbleSortSeleniumTestsCases(unittest.TestCase):
    ...
    def test_page(self):
        ...
        page = self.driver.find_element(By.ID, "bubbleSort")
        page.click()
        ...
        self.assertEqual(result_text, "3,0;3,0;4,0;4,0;4,0;4,0;4,0;4,5;5,0;5,0;6,0",
        ...
        result_text = result.text
        self.assertTrue(len(result_text) > 0, msg = "Result should appear")
        self.assertEqual(result_text, "6,0;5,0;5,0;4,5;4,0;4,0;4,0;4,0;4,0;3,0;3,0",
